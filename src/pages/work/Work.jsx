    ...
    return (
        ...
        <section className="container mx-auto py-12 px-4">
          ...
          <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
            {/* Work Item 1 */}
            <div className="p-4 border border-gray-700 bg-black rounded-lg shadow-lg transform hover:scale-105 transition duration-300 ease-in-out">
              <img
            ...
            {/* Work Item 2 */}
            <div className="p-4 border border-gray-700 bg-grey-900 rounded-lg shadow-lg transform hover:scale-105 transition duration-300 ease-in-out">
              <img
        ...
        <section className="relative bg-black">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center space-y-4">
            <h1 className="text-7xl font-extrabold tracking-tight italic">
